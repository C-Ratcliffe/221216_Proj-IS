...
for (i in opt.mods[-6]){
	...
	asegvol_ints[, 2] <- (asegvol_ints[, 2] - min(asegvol_ints[, 2])) / (max(asegvol_ints[, 2]) - min(asegvol_ints[, 2]))
	...
	cortthi_ints[is.nan(cortthi_ints[, 2]), 2] <- min(
		cortthi_ints
		, na.rm = T
		)
	cortthi_ints[, 2] <- (cortthi_ints[, 2] - min(cortthi_ints[, 2])) / (max(cortthi_ints[, 2]) - min(cortthi_ints[, 2]))
	...
	cortvol_ints[, 2] <- (cortvol_ints[, 2] - min(cortvol_ints[, 2])) / (max(cortvol_ints[, 2]) - min(cortvol_ints[, 2]))
